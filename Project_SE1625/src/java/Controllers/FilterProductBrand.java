 ...
 * @author Lenovo
 */
public class FilterProductBrand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Product> pList = u.FilterProductsByBrand(brand);
            request.setAttribute("pList", pList);
            request.setAttribute("method", "FilterProductBrand");
